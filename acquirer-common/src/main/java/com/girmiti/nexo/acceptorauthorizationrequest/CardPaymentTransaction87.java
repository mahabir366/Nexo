 ...
 *       &lt;sequence>
 *         &lt;element name="TxCaptr" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}TrueFalseIndicator"/>
 *         &lt;element name="TxTp" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}CardPaymentServiceType12Code" minOccurs="0"/>
 *         &lt;element name="AddtlSvc" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}CardPaymentServiceType9Code" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="SvcAttr" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}CardPaymentServiceType3Code" minOccurs="0"/>
 *         &lt;element name="LastTxFlg" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}TrueFalseIndicator" minOccurs="0"/>
 *         &lt;element name="MrchntCtgyCd" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}Min3Max4Text" minOccurs="0"/>
 *         &lt;element name="CstmrCnsnt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}TrueFalseIndicator" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="CardPrgrmmPropsd" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="CardPrgrmmApld" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}Max35Text" minOccurs="0"/>
 *         &lt;element name="SaleRefId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}Max35Text" minOccurs="0"/>
 *         &lt;element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}TransactionIdentifier1"/>
 *         &lt;element name="OrgnlTx" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}CardPaymentTransaction79" minOccurs="0"/>
 *         &lt;element name="InitrTxId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}Max35Text" minOccurs="0"/>
 *         &lt;element name="RcncltnId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}Max35Text" minOccurs="0"/>
 *         &lt;element name="TxDtls" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}CardPaymentTransactionDetails47"/>
 *         &lt;element name="MrchntRefData" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}Max70Text" minOccurs="0"/>
 *         &lt;element name="AcctFr" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}CardAccount15" minOccurs="0"/>
 *         &lt;element name="AcctTo" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}CardAccount15" minOccurs="0"/>
 *         &lt;element name="AddtlTxData" type="{urn:iso:std:iso:20022:tech:xsd:caaa.001.001.08}Max70Text" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
