 ...
 *       &lt;sequence>
 *         &lt;element name="Ccy" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}ActiveCurrencyCode" minOccurs="0"/>
 *         &lt;element name="TtlAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}ImpliedCurrencyAndAmount"/>
 *         &lt;element name="CmltvAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="AmtQlfr" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}TypeOfAmount8Code" minOccurs="0"/>
 *         &lt;element name="DtldAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}DetailedAmount15" minOccurs="0"/>
 *         &lt;element name="ReqdAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="AuthrsdAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="InvcAmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="VldtyDt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}ISODate" minOccurs="0"/>
 *         &lt;element name="OnLineRsn" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}OnLineReason1Code" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="UattnddLvlCtgy" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}Max35NumericText" minOccurs="0"/>
 *         &lt;element name="AcctTp" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}CardAccountType3Code" minOccurs="0"/>
 *         &lt;element name="CcyConvsRslt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}CurrencyConversion15" minOccurs="0"/>
 *         &lt;element name="Instlmt" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}RecurringTransaction2" minOccurs="0"/>
 *         &lt;element name="AggtnTx" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}AggregationTransaction2" minOccurs="0"/>
 *         &lt;element name="PdctCdSetId" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}Max10Text" minOccurs="0"/>
 *         &lt;element name="SaleItm" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}Product6" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="DlvryLctn" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}Max35Text" minOccurs="0"/>
 *         &lt;element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:caaa.018.001.03}IndustryData1" maxOccurs="unbounded" minOccurs="0"/>
